...
4) Metrics beyond loss:
   - quality (ROUGE-L F1) # ROUGE-L F1 is a common metric for summarization quality, capturing both precision and recall of longest common subsequence between generated summary and reference summary. 
